...
import NavBarForDFormation from "@/components/common/layout/NavBarForDFormation.vue";
import FormationSimilaire from "@/components/formation/FormationSimilaire.vue";
